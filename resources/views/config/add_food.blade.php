			...
			<div class="container">
			    <div class="row">
			        <div class="col-md-10 col-md-offset-1">
			        	<div class="col-md-12">
			        		<a href="{{ url('config/edit_food') }}" class="btn btn-danger btn-lg button_add">Управління продуктами</a>
			        		<a href="{{ url('config/edit_additionallies') }}" class="btn btn-warning btn-lg right_price">Управління складниками</a>
			        	</div>
						    ...
						    <div class="col-md-12 center_text">
						        <form method="POST" action="{{route('addAdditional')}}" enctype="multipart/form-data">
									...
									<div class="form-group">
								  	...
								  	<div class="form-group">
								  		<label>Ціна за складник(ціна за продукт додається автоматично!)</label>
									    <div class="col-md-6">
